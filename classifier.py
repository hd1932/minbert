...
class BertSentimentClassifier(torch.nn.Module):
    ...
    Thus, tthe forward() returns one logit for each of the 5 classes.
    '''
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # Dropout on [CLS] token embedding
        # Get logits after passing [CLS] token embedding through classifier
